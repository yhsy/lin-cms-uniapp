<template>
	<view class="page-news" style="position: absolute;">
		<!-- #ifdef APP-NVUE -->
		<list class="listview" enableBackToTop="true" scroll-y loadmoreoffset="15" @loadmore="loadMore()">
			...
			<cell v-for="(item, index) in dataList" :key="item.id">
				<news-item :data="item" @close="closeItem(index)" @click="goDetail(item)"></news-item>
			</cell>
			<cell class="loading-more" v-if="isLoading || dataList.length > 4">
